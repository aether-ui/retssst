  ...
  const navItems = [
    { 
      ...
      children: [
        ...
        { name: 'Limited Drops', path: '/products?category=limited-drops' },
    ...
    { 
      ...
      path: '/collections',
      children: [
        { name: 'Summer 2025', path: '/collections/summer-2025' },
        { name: 'Urban Classics', path: '/collections/urban-classics' },
        { name: 'Street Art Series', path: '/collections/street-art-series' }
      ]
    },
